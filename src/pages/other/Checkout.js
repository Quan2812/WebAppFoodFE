...
const Checkout = ({ location, cartItems, currency, confirmOrders }) => {
  const validateUserOrder = (userOrder) => {
    ...
    console.log("userOrder.address", userOrder.address.trim() !== "");
    console.log("userOrder.pickupTime", userOrder.pickupTime);
    console.log("userOrder.districts", userOrder.districts);
    console.log("userOrder.wards", userOrder.wards);
